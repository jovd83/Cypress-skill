---
name: cypress-mapper-testlink
description: A skill to map TestLink unique IDs back to local Cypress test documentation.
---
...
2. Scan the local test documentation and Cypress automation code (`.spec.ts` files).
3. Annotate the test names by adding the ID between brackets `[ ]` at the beginning of the test name.
   ...
   - Example Cypress: `it('[TC-101] Verify user login...', () => {})`

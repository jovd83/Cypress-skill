...
description: A skill to use TestRail APIs to report Cypress test execution results.
---
...
2. Install the `cypress-testrail-reporter` or `@zealteam/testrail-reporter` library via npm.
3. Configure the reporter in `cypress.config.ts` making sure all environment variables are correctly mapped.

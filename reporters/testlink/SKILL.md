---
name: cypress-reporter-testlink
description: Test-management reporting skill for TestLink. Use when Codex needs to publish Cypress execution results into TestLink using the project's mappings, environment configuration, and chosen reporting flow.
metadata:
  author: jovd83
  version: "1.1"

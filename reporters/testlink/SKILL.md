...
description: A skill to use TestLink APIs to report Cypress test execution results.
---
...
3. Read the latest Cypress test results (e.g., from `cypress-report/` or standard out).
